  ...
  return (
    <div className="container mx-auto px-6 py-20 min-h-screen">
        <div className="max-w-3xl mx-auto">
          ...
          >
            <h1 className="heading-display text-4xl sm:text-5xl mb-8 sm:mb-12">About</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-16 sm:mb-20">
            <GlassCard delay={0.2} className="flex flex-col gap-3 sm:gap-4">
              <h3 className="text-[10px] sm:text-xs uppercase tracking-widest text-white/30">Philosophy</h3>
            ...
            <GlassCard delay={0.3} className="flex flex-col gap-3 sm:gap-4">
              <h3 className="text-[10px] sm:text-xs uppercase tracking-widest text-white/30">Interests</h3>
              <p className="text-sm text-white/70 font-light">
          ...
          >
            ...
            >
              ...
              <span className="text-xs sm:text-sm font-light">View Professional Path</span>
